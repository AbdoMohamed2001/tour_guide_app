...
class AllTourCompanies extends StatelessWidget {
  static String id = 'allTour';
  ...
  Widget build(BuildContext context) {
    CollectionReference tour_companies = cityDocId.collection('Tourism Companies');
    return FutureBuilder<QuerySnapshot>(
        future: tour_companies.get(),
